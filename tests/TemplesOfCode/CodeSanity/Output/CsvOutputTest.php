...
class CsvOutputTestRemoteMockLocation extends RemoteLocation
{
    /**
     * {@inheritdoc}
     */
...
OUT;
     ...
     * @var string
     */
    private static $csvExpectedOutput2=<<<OUT
Source of truth Location,Source of truth File Hash,Target Location,Target File Hash
/dir1/dir2/dir3/22222,9o9o9o9o9o,mockUser@mockHost:/dir1/dir2/dir4/22222,1a9b9508b6003b68ddfe03a9c8cbc4bd4388339b
/dir1/dir2/dir3/33333,403d9917c3e950798601addf7ba82cd3c83f344b,mockUser@mockHost:/dir1/dir2/dir4/33333,8a8a8a8a8
/dir1/dir2/dir3/88888,9eab102e8f9431bb23016851d11e658e0b20b730,Missing,Missing
Missing,Missing,mockUser@mockHost:/dir1/dir2/dir4/77777,d559965849921585c1849af03b7a51638700d979
...
OUT;
    ...
    public function testWriteWithRemoteLocation()
    {
        $finder = new CsvOutputTestFinder();
        ...
        $targetLocation1 = new CsvOutputTestRemoteMockLocation('/dir1/dir2/dir4');
        $roster2 = new Roster();
        $targetLocation1->setRoster($roster2);
        $finder->addTargetLocation($targetLocation1);
        $targetLocation1->buildRoster();
        ...
        $targetLocation1->setRemoteConnection($remoteConnection);
...
//        
        ...
        $this->assertEquals(self::$csvExpectedOutput2, $content);
    }
}
